...
const Cards = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="grid grid-cols-1 text-white sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-3 w-full max-w-4xl">
        {/* Card 1(Tanay) */}
        <div className="card w-full bg-gray-800 shadow-xl m-2">
          <figure>
        ...
        {/* Card 2(Srijan) */}
        <div className="card w-full text-white bg-gray-800 shadow-xl m-2">
          <figure>
